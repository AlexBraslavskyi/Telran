...
void logTypesBadRequest() {
	...
	badRequest(LOGS_TYPE, TYPE, null);
}
@Test
void exceptionEncounteredBadRequest() {
	badRequest(LOGS_EXCEPTION_ENCOUNTERED, AMOUNT, "ab");
	badRequest(LOGS_EXCEPTION_ENCOUNTERED, AMOUNT, "-1");
}
@Test
void artifactEncounteredBadRequest() {
	badRequest(LOGS_ARTIFACT_ENCOUNTERED, AMOUNT, null);
	badRequest(LOGS_ARTIFACT_ENCOUNTERED, AMOUNT, "-1");
}
