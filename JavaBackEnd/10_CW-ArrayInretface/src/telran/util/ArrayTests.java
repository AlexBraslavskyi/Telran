...
class ArrayTests {
	...
	String [] arrayStr = {"abc", "def", "www","qww","www"};
...
//}
	...
	void testReverse() {
		...
		String expArrayStr [] = {"www","qww","www", "def", "abc"};
		arInt.reverse();
		arStr.reverse();
	assertEquals(arrayInt.length, arInt.size());
	assertEquals(arrayStr.length, arStr.size());
	...
	@Test
	void testIndexOf() {
	assertEquals(4, arInt.indexOf(9));
	assertEquals(2, arStr.indexOf("www"));

	}
	@Test
	void testLastIndexOf() {

		assertEquals(3, arInt.lastIndexOf(10));
		assertEquals(4, arStr.lastIndexOf("www"));
	}
}
