...
//		int day;
//		try {
//			day = args.length > 1 ?Integer.parseInt(args[2]) : LocalDate.now().getYear();
//			if(year < 0) {
//				throw new Exception("day should be only positive value");
//			}
//		} catch (NumberFormatException e) {
//			throw new Exception(String.format("you have entered $s but year value shuuld be a positive number ", args[2]));
//			
//		}
