...
var thCarsStatisticsElement =
    document.getElementById('thCarsStatistics');
var tBodyCarsStatisticsElement =
    document.getElementById('tBodyCarsStatistics');
var tableCarsStatistics = new Table(['model', 'occurrences'],
    thCarsStatisticsElement, tBodyCarsStatisticsElement);
...
//get model names
    var modelNames = cars.map(function(c) {
        return c.model;
    })
    var modelOccurrences = getOccurrences(modelNames);
    var models = Object.keys(modelOccurrences);
    tableCarsStatistics.clear();
    models.forEach(function(model) {
        tableCarsStatistics.addRow({model,
        occurrences: modelOccurrences[model]});
    })
}
