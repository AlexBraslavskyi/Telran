...
import TitleStatistics from "./homework/hw6_EmployeesRouting/TitleStatistics";
import {pathEmployees,pathTitleStatistics,pathSearch,pathSalaryStatistics,pathGenerations} from "./homework/hw6_EmployeesRouting/EmployeesConfig";
import EmployeesGenerations from "./homework/hw6_EmployeesRouting/EmployeesGenerations";
import SalaryStatistics from "./homework/hw6_EmployeesRouting/SalaryStatistics";
import EmployeesSearch from "./homework/hw6_EmployeesRouting/EmployeesSearch";
...
class App extends React.Component{
    ...
    <Switch>
      ...
      <Route path={pathGenerations} exact render={() =>
        {return <EmployeesGenerations  updateEmployeesFn={this.employeesUpdate.bind(this)}/>}}/>
